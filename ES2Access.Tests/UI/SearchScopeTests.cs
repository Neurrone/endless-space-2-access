...
namespace ES2Access.Tests.UI
{
    ...
    public class SearchScopeTests
    {
        ...
        private static GraphRender Build(bool expandAll)
        {
            ...
            builder.BeginGroup(Graphs.Id("open"), Graphs.Vt("Serpens"), expanded: true);
            builder.AddItem(Graphs.Id("open/star"), Graphs.Vt("Dusay"));
            builder.EndGroup();
            builder.BeginGroup(Graphs.Id("shut"), Graphs.Vt("Osulo group"), expanded: false);
            builder.AddItem(Graphs.Id("shut/star"), Graphs.Vt("Osulo"));
            builder.BeginGroup(Graphs.Id("shut/deep"), Graphs.Vt("Osulo I"), expanded: false);
            builder.AddItem(Graphs.Id("shut/deep/deposit"), Graphs.Vt("Antimatter"));
            builder.EndGroup();
            builder.EndGroup();
