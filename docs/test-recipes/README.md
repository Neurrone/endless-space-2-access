...
| `modals-and-outgame.md` | Opening modals from `/eval`, the election wizard, minor civilizations, the pirate window, the load/save modal, the loading screen, the cutscene modal, DLC, the out-game family, chat |
