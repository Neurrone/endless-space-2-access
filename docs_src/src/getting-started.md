...
- `Ctrl+Enter`: Ctrl-click, toggles selection, locate missing technology
- `Shift+Enter`: Shift-click, extends the selection to here
- `Ctrl+Alt+Enter`: double click
- `Ctrl+Backslash`: Ctrl+right-click

## Type-ahead search

Start typing to find something in the current tab stop. This is especially useful in long lists like the technology tree or list of constructions.
