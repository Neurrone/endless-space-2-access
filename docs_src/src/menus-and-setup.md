...
The new game lobby has the setup rows — galaxy shape, size, difficulty, the competitors, the victory conditions — plus its action buttons. Each competitor is a row of its own.
