...
namespace ES2Access.Core.UI.Graph
{
    ...
    public sealed class KeyGraph
    {
        ...
        /// wires its first row up to the sort-header band above it and chains its last row down into
        /// the next section's first, so an unbounded walk ends on a header or in another table - two
