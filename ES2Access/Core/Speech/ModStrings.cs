...
namespace ES2Access.Core.Speech
{
    ...
    public static partial class ModStrings
    {
        ...
        private static readonly Dictionary<string, string> Defaults = new Dictionary<string, string>
        {
            ...
            { GalaxyQuestMarkerAtSystem, "Quest: {0}, at {1}" },
            { GalaxyQuestMarkerAtSystemPinned, "Tracked quest: {0}, at {1}" },
            { GalaxyQuestMarkerOnPlanet, "Quest: {0}, on {1}" },
            ...
            { GalaxyQuestMarkerOnFleetPinned, "Tracked quest: {0}, on fleet {1}" },
            { GalaxyQuestMarkerUnexplored, "Quest: {0}, at an unexplored system" },
            { GalaxyQuestMarkerUnexploredPinned, "Tracked quest: {0}, at an unexplored system" },
            { GalaxyPlanetPlace, "{0}, {1}" },
            {
            ...
            { ShipDesignSlotBroadsideTakes, "Broadside, {0}" },
            { ShipDesignSlotFrontTurretTakes, "Front turret, {0}" },
            { ShipDesignSlotRightBroadsideTakes, "Right broadside, {0}" },
            { ShipDesignSlotLeftBroadsideTakes, "Left broadside, {0}" },
            { ShipDesignSlotRearTurretTakes, "Rear turret, {0}" },
            { ShipDesignSlotBroadside, "broadside" },
            { ShipDesignSlotFrontTurret, "front turret" },
            { ShipDesignSlotRightBroadside, "right broadside" },
            { ShipDesignSlotLeftBroadside, "left broadside" },
            { ShipDesignSlotRearTurret, "rear turret" },
            ...
            { BattleFlotillaShipStanding, "{0} ship standing" },
            { BattleFlotillaShipsStanding, "{0} ships standing" },
            { BattleFlotillaShipDestroyed, "{0} ship destroyed" },
            { BattleFlotillaShipsDestroyed, "{0} ships destroyed" },
