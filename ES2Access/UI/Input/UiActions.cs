namespace ES2Access.UI.Input
{
    ...
    public static class UiActions
    {
        ...
        public const string ReturnToPrevious = "ui.returnToPrevious";
        ...
        public const string AltClick = "ui.altClick";
        ...
        /// from. Where it is put DOWN is named with <see cref="Click"/>.</summary>
        ...
        public const string CtrlClick = "ui.ctrlClick";
        public const string ShiftClick = "ui.shiftClick";
