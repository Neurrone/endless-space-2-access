...
namespace ES2Access.Screens
{
    ...
    public sealed partial class NotificationScreen : Screen
    {
        ...
        /// words rather than the last one's - and, because the popup's arrival fade is finished the
        /// moment the game starts it (<see cref="NotificationArrival"/>), when what those labels say
        /// is on the screen to be landed on.</summary>
