    ...
    public sealed class MilitaryScreen : Screen
    {
        ...
        private static bool DeckSlot(List<Cell> cells, AgeTransform widget, string keyPrefix)
        {
            ...
            NodeVtable vtable = new NodeVtable
            {
                ...
                // marking, each in the name's own kind so it sorts beside the name - and, because the
                // buffer lists every part spoken beside the name, each its own buffer line with no
                // second declaration. An empty or locked slot draws none and says none.
